        ...
        _filter_table = rooms.filter(room =>{
                if(room){
                    if(options_search.keyword === 'ทั้งหมด'){
                        ...
                        return (room.roomtype.search(options_search.text) !== -1 )	||
                        (options_search.text === '')		
                    }else{
                        return false; 
                    }
            ...
            <div className= {styles.container}>
                ...
                <div className= {styles.mainbox}>
                    ...
                    <div className= {styles.buttonstyles} >
                        <button display = "disabled" id = 'save' className= {styles.buttonsave} onClick={ saveconfig
                            
                        }><SaveIcon/>บันทึก</button>
                        <button id= 'edit' className= {styles.buttoncancel} onClick={ editconfig 
                            
                        }><HighlightOffIcon/>แก้ไข</button>
                    </div>
