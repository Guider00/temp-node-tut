...
export const Menubar = () => {
    ...
    return (
        <>
            <nav className={click ? styles.menu_1 : styles.menu}>
                <div className={styles.logo}>
                    <img onClick={check_menu} src="/image/logo.png" alt="logo" width="60" height="50" />
                </div>
                <div id='menu' className={click ? styles.menu_left_1 : styles.menu_left}>
                    <div>
                        <a href="/home">
                            <button>
                                <div>
                    ...
                    <div className={styles.dropdown}>
                        <div>
                            <div>
                                <Submenudropdown className={styles.drop} id="submenusetting" label="Report" icon="list" links={[
